...
<div class="page-banner">
    ...
    <div class="page-banner__content container container--narrow">
        <h1 class="page-banner__title">Benvinguts al nostre Blog</h1>
        <div class="page-banner__intro">
            <p>Aquí trobareu les nostres notícies</p>
        </div>
    </div>
</div>
    ...
    <?php
        while(have_posts()){
            ...
            <div class="post-item">
                ...
                <div class="metabox">
                    <p>Posted by a <?=the_author_posts_link()?> on a <?=the_time('d-m-Y')?> in <?=get_the_category_list(', ')?></p>
                </div>
